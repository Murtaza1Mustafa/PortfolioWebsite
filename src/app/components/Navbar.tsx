...
<div className="flex flex-col md:flex-row md:space-x-4 space-y-2 md:space-y-0 w-full md:justify-end">
  <Link className={getClasses("/")} href="/">Home</Link>
  <Link className={getClasses("/about")} href="/about">About</Link>
  <Link className={getClasses("/Projects")} href="/Projects">Projects</Link>
