    ...
    <div className='relative'>
      ...
      <section className='w-full min-h-screen flex flex-col items-center justify-center px-6 text-center bg-[#f0fbff]'>
        ...
        <p className='text-lg md:text-xl max-w-2xl mb-8 text-[#023e8a]'>
          I’m <span className='font-semibold text-[#0077b6]'>Murtaza Mustafa</span>, a game and
          software developer passionate about building interactive systems and creative experiences.
        </p>
        ...
        <div className='flex flex-col bg-[#00b4d8] rounded-2xl shadow-lg shadow-[#0077b6]/40 p-4 md:p-6 2xl:p-8 cursor-pointer'>
          ...
          <p className='text-white mt-2 max-w-md'>
            A fishing game that goes through the loop of fishing, cleaning the fish and feeding them
